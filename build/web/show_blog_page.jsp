...
<!--    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v19.0" nonce="ungafH4J"></script>-->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="profile.jsp"> <span class="fa fa-code"></span> Learn code with Deepak <span class="sr-only">(current)</span></a>
                </li>
...
<!--                    <div class="card-footer">
                        <div class="fb-comments" data-href="http://localhost:8181/TechBlog/show_blog_page.jsp?post_id=<%=p.getPid()%>" data-width="" data-numposts="5"></div>
                    </div>-->
                </div>
            </div>
        </div>
